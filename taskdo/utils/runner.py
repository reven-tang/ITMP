...
from taskdo.utils.callback import AdHocResultCallback, PlaybookResultCallBack, CommandResultCallback
from taskdo.utils.exceptions import AnsibleError
...
class CommandRunner(AdHocRunner):
    ...
    modules_choices = ('shell', 'command', 'copy', 'cron', 'file', 'raw', 'unarchive', 'script', 'setup',
                       'service', 'synchronize', 'yum')
